...
<form id="form" method = 'POST' action = 'clogin.php'>

   <table width="100%" border="1" align="center">
   <tr>
     <td align ='center' colspan = '6' ><h1><b>Candidates Log In</b></h1></td>
   </tr>
   <tr>
     <td>First Name:</td>
   ...
   <tr>
     ...
     <td align='center' colspan='6'><input type='submit'  name = 'submit' value = 'Log In' class="btn"/>
         <p class="login__signup">Don't have an account? &nbsp;<a href="cregistration.php">Sign up</a></p>
     </td>
...
if(isset($_POST['submit'])){
	...
	$query = "select * from addcandidate where firstname = '$Firstname' AND password1 = '$Password' ";
	$result = mysqli_query($conn, $query);
	
				if ($Firstname==''){
				echo "<script>alert('Numeral Value in String Field')</script>";
				exit();
				}	
				if ($Password==''){
